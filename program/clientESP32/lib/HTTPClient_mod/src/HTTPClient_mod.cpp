 ...
 * @return success bool
 */
bool HTTPClient_mod::begin(WiFiClient &client, String url) {
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
 ...
 * @return success bool
 */
bool HTTPClient_mod::begin(WiFiClient &client, String host, uint16_t port, String uri, bool https)
{
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool HTTPClient_mod::begin(String url, const char* CAcert)
{
 ...
 * @param url String
 */
bool HTTPClient_mod::begin(String url)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClient_mod::beginInternal(String url, const char* expectedProtocol)
{
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool HTTPClient_mod::begin(String host, uint16_t port, String uri)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClient_mod::begin(String host, uint16_t port, String uri, const char* CAcert)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClient_mod::begin(String host, uint16_t port, String uri, const char* CAcert, const char* cli_cert, const char* cli_key)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
 ...
 */
void HTTPClient_mod::disconnect(bool preserveClient)
{
    if(connected()) {
 ...
 * @param reuse bool
 */
void HTTPClient_mod::setReuse(bool reuse)
{
    _reuse = reuse;
}
 ...
 */
void HTTPClient_mod::setUserAgent(const String& userAgent)
{
 ...
 */
void HTTPClient_mod::setAuthorization(const char * user, const char * password)
{
    if(user && password) {
        String auth = user;
        auth += ":";
 ...
 */
void HTTPClient_mod::setAuthorization(const char * auth)
{
    if(auth) {
 ...
 */
void HTTPClient_mod::setAuthorizationType(const char * authType)
{
    if(authType) {
 ...
 */
void HTTPClient_mod::setConnectTimeout(int32_t connectTimeout)
{
 ...
 */
void HTTPClient_mod::setTimeout(uint16_t timeout)
{
    _tcpTimeout = timeout;
    if(connected()) {
 ...
 * @param use
 */
void HTTPClient_mod::useHTTP10(bool useHTTP10)
{
 ...
 * @return http code
 */
int HTTPClient_mod::POST(uint8_t * payload, size_t size)
{
    return sendRequest("POST", payload, size);
}

int HTTPClient_mod::POST(String payload)
{
 ...
 * @return http code
 */
int HTTPClient_mod::PATCH(uint8_t * payload, size_t size)
{
    return sendRequest("PATCH", payload, size);
}

int HTTPClient_mod::PATCH(String payload)
{
 ...
 * @return http code
 */
int HTTPClient_mod::PUT(uint8_t * payload, size_t size) {
    return sendRequest("PUT", payload, size);
}

int HTTPClient_mod::PUT(String payload) {
 ...
 * @return
 */
int HTTPClient_mod::sendRequest(const char * type, String payload)
{
 ...
 */
int HTTPClient_mod::sendRequest(const char * type, uint8_t * payload, size_t size)
{
    int code;
    bool redirect = false;
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HTTPClient_mod::sendRequest(const char * type, Stream * stream, size_t size)
{
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HTTPClient_mod::getSize(void)
{
    return _size;
}
 ...
 * @return WiFiClient
 */
WiFiClient& HTTPClient_mod::getStream(void)
{
    if (connected()) {
        return *_client;
    }
 ...
 * @return WiFiClient*
 */
WiFiClient* HTTPClient_mod::getStreamPtr(void)
{
    if(connected()) {
        return _client;
    }
 ...
 */
int HTTPClient_mod::writeToStream(Stream * stream)
{
 ...
 * @return String
 */
String HTTPClient_mod::getString(void)
{
 ...
 * @return String
 */
String HTTPClient_mod::errorToString(int error)
{
    switch(error) {
 ...
 * @param first
 */
void HTTPClient_mod::addHeader(const String& name, const String& value, bool first, bool replace)
{
...
void HTTPClient_mod::collectHeaders(const char* headerKeys[], const size_t headerKeysCount)
{
...
String HTTPClient_mod::header(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
...
String HTTPClient_mod::header(size_t i)
{
...
String HTTPClient_mod::headerName(size_t i)
{
    if(i < _headerKeysCount) {
...
int HTTPClient_mod::headers()
{
    return _headerKeysCount;
}

bool HTTPClient_mod::hasHeader(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
 ...
 */
bool HTTPClient_mod::connect(void)
{
    if(connected()) {
        if(_reuse) {
 ...
 * @return status
 */
bool HTTPClient_mod::sendHeader(const char * type)
{
    if(!connected()) {
        return false;
    }
 ...
 */
int HTTPClient_mod::handleHeaderResponse()
{
 ...
 */
int HTTPClient_mod::writeToStreamDataBlock(Stream * stream, int size)
{
    int buff_size = HTTP_TCP_BUFFER_SIZE;
    int len = size;
    int bytesWritten = 0;
 ...
 * @return error
 */
int HTTPClient_mod::returnError(int error)
{
    if(error < 0) {
...
void HTTPClient_mod::setFollowRedirects(followRedirects_t follow)
{
    _followRedirects = follow;
}

void HTTPClient_mod::setRedirectLimit(uint16_t limit)
{
 ...
 * @param url
 */
bool HTTPClient_mod::setURL(const String& url)
{
...
const String &HTTPClient_mod::getLocation(void)
{
    return _location;
}

void HTTPClient_mod::setCookieJar(CookieJar* cookieJar)
{
    _cookieJar = cookieJar;
}

void HTTPClient_mod::resetCookieJar()
{
    _cookieJar = nullptr;
}

void HTTPClient_mod::clearAllCookies()
{
    if (_cookieJar) _cookieJar->clear();
}

void HTTPClient_mod::setCookie(String date, String headerValue)
{
    if (!_cookieJar)
    {
        return;
...
bool HTTPClient_mod::generateCookieString(String *cookieString)
{
    time_t now_local = time(NULL);
    time_t now_gmt = mktime(gmtime(&now_local));
